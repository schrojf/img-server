...
<div class="w-full max-w-sm">
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <button type="submit"
                class="w-full bg-blue-600 text-white text-sm font-medium rounded px-4 py-2 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            Login
        </button>
    </form>
</div>
